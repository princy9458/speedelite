...
export default function EventsAdmin() {
  ...
  const handleBulkDelete = async () => {
    ...
    if (!confirm(`Delete ${selectedIds.length} events? This cannot be undone.`)) return;
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="text-4xl font-serif gold-text">Event Management</h1>
        </div>
      ...
      <div className="flex items-center justify-between text-sm text-white/50">
        <span>
          Page {eventFilters.page} of {totalPages}
        </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
          <div className="glass-card w-full max-w-2xl rounded-2xl border border-white/10 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-serif">Quick Edit</h2>
