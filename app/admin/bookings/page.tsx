                ...
                <tr key={booking._id} className="group border-t border-white/5 transition-colors hover:bg-white/[0.04]">
                  ...
                  <td className="p-4 text-white/60">
                    ...
                    <p className="text-xs text-white/45">
                      {booking.event?.date ? new Date(booking.event.date).toLocaleDateString(locale) : '-'} {booking.event?.time || ''}
                    </p>
                  </td>
                  ...
                  <td className="p-4 text-white/50">{new Date(booking.createdAt).toLocaleDateString(locale)}</td>
