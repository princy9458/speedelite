      ...
      <header className="bg-black/50 border-b border-white/10 sticky top-0 z-50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <span className="text-white/70 hidden md:inline-block">{t('welcome')}, {user.email}</span>
            <button 
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        <section>
          ...
          {bookings.length === 0 ? (
            <div className="bg-white/5 border border-white/10 rounded-3xl p-12 text-center text-white/50">
              <p className="mb-6">{t('noBookings')}</p>
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="pt-4 border-t border-white/10 flex justify-between items-center text-sm">
                        <span className="text-white/50">{t('ticketId')}: #{booking._id.slice(-6).toUpperCase()}</span>
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-serif">{t('upcomingEvents')}</h2>
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-4 border-t border-white/10 flex justify-between items-center">
                      ...
                      <span className="text-[#F4D693] font-bold">{t('fromPrice', { price: Math.min(event.priceFemale, event.priceMale) })}</span>
                    </div>
                  </div>
                </motion.div>
              </Link>
