...
import ApplyRouteGuard from "@/components/apply/ApplyRouteGuard";
...
export default function ApplyLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-[#E5E2E1] selection:bg-[#C9A646]/30">
      ...
      <ApplyHeader />
      <main className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 transition-all duration-700">
